...
namespace Spark.GL
{
    public static class FrustumCullingHelper
    {
        public static float[,] Frustum = new float[6, 4];

        public static void ExtractFrustum(Camera cam)
        {
            ExtractFrustum(cam.GetViewMatrix() * cam.CreateView(Window.window.Width, Window.window.Height));
        }
        ...
        #region Point
        static public bool PointInFrustum(Vec3 Position)
        {
            for (int i = 0; i < 6; i++)
        ...
        #region Sphere
        public static bool SphereInFrustum(Vec3 Position, float Radius)
        {
            for (int i = 0; i < 6; ++i)
        ...
        public static int SphereInFrustumIntersect(Vec3 Position, float Radius)
        {
            int c = 0;
            float d;
            for (int i = 0; i < 6; i++)
        ...
        #region Box
        public static bool BoxInFrustum(Vec3 Position, Vec3 Size)
        {
            for (int i = 0; i < 6; i++)
            {
        ...
        public static bool BoxInFrustum(float X, float Y, float Z, Vec3 Size)
        {
            for (int i = 0; i < 6; i++)
            {
        ...
        public static int BoxInFrustumIntersect(Vec3 Position, Vec3 Size)
        {
            int c;
            int c2 = 0;
            for (int i = 0; i < 6; i++)
        ...
        public static int BoxInFrustumIntersect(float X, float Y, float Z, Vec3 Size)
        {
            int c;
            int c2 = 0;
            for (int i = 0; i < 6; i++)
